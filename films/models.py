...
class Film(models.Model):
    ...
    actors = models.ManyToManyField(Actor, verbose_name="Акткры", related_name="film_actor")
...
class RatingStar(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = "Звезды рейнига"
        ordering = ["-value"]
...
class Rating(models.Model):
    ...
    movie = models.ForeignKey(Film, on_delete=models.CASCADE, verbose_name="фильм", related_name="ratings")
...
class Review(models.Model):
    ...
    film = models.ForeignKey(Film, verbose_name="фильм", on_delete=models.CASCADE, related_name="review")
